...
$overlay_html = '';
if ($overlay_color != '' ) {
	$css_classes[] = 'vc_section-overlay';
	$overlay_html = '<div class="vc_section-overlay-color" style="background-color: '.esc_attr($overlay_color).';"></div>';
}

/*Disable Background Image*/
if ($disable_bg_image != 'none' ) {
	$css_classes[] = 'vc_disable-bg-img-'.$disable_bg_image;
}
...
$output .= '<div ' . implode( ' ', $wrap_attr ) . '>'.$overlay_html;
