 ...
 */
function asata_taxonomy_settings_field($settings, $value) {
    ...
    if (!empty($settings['taxonomy'])) {
        $terms = get_terms($settings['taxonomy'], 'hide_empty=true');
...
asata_add_extra_parame('bt_taxonomy', 'asata_taxonomy_settings_field', get_template_directory_uri().'/assets/vc_extend/vc_taxonomy.js');

/*
 * Layout select list field
 */
function asata_layout_settings_field($settings, $value) {
    $dependency = function_exists('vc_generate_dependencies_attributes') ? vc_generate_dependencies_attributes($settings) : '';
...
asata_add_extra_parame('bt_layout', 'asata_layout_settings_field', get_template_directory_uri().'/assets/vc_extend/vc_layout.js');
