...
add_action( 'tgmpa_register', 'asata_register_required_plugins' );
 ...
 */
function asata_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			'name'      => esc_html__('Redux Framework', 'asata'),
		...
		array(
			'name'      => esc_html__('Custom Post Type UI', 'asata'),
			'slug'      => 'custom-post-type-ui',
			'required'  => true,
		),
		array(
			'name'         => esc_html__('WPBakery Page Builder', 'asata'),
			'slug'         => 'js_composer',
			'source'       => $root.'js_composer.zip',
			'required'     => true,
		),
		array(
			'name'         => esc_html__('Slider Revolution', 'asata'),
			'slug'         => 'revslider',
			'source'       => $root.'revslider.zip',
			'required'     => true,
		),
		array(
			'name'      => esc_html__('WooCommerce', 'asata'),
			'slug'      => 'woocommerce',
			'required'  => false,
		),
		array(
			'name'      => esc_html__('Contact Form 7', 'asata'),
			'slug'      => 'contact-form-7',
			'required'  => false,
		),
		array(
