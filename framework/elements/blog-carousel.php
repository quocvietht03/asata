...
class WPBakeryShortCode_bt_blog_carousel extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		$css_class = array(
			...
			'bt-element bt-blog-carousel-element',
			$layout,
			$nav_dots,
...
vc_map(array(
	'name' => esc_html__('Blog Carousel', 'asata'),
    ...
    'params' => array_merge(
		...
		vc_map_add_post_media_group('media', 'Item', array( 'element' => 'layout', 'value' => array('default', 'layout1', 'layout2', 'layout3', 'layout4') )),
