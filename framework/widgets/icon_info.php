<?php
class asata_Icon_Info_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'icon_info_widget', // Base ID
                esc_html__('Icon Info', 'asata'), // Name
                array('description' => esc_html__('Icon Info Widget', 'asata'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('font_icon')); ?>"><?php esc_html_e('Icon:', 'asata');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('meta_info')); ?>"><?php esc_html_e('Text:', 'asata');
		 ?></label>
