...
$post_share_label = isset($asata_options['single_portfolio_share_label'])&&$asata_options['single_portfolio_share_label'] ? $asata_options['single_portfolio_share_label']: esc_html__('Share', 'asata');
$social_item = array();
