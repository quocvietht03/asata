...
$fullwidth = isset($asata_options['portfolio_fullwidth'])&&$asata_options['portfolio_fullwidth'] ? 'container-fluid': 'bt-container';
$columns = (int) isset($asata_options['portfolio_columns']) ?  $asata_options['portfolio_columns']: 1;
$sidebar_width = (int) isset($asata_options['portfolio_sidebar_width']) ?  $asata_options['portfolio_sidebar_width']: 3;
...
$portfolio_titlebar = isset($asata_options['portfolio_titlebar']) ? $asata_options['portfolio_titlebar']: true;
if($portfolio_titlebar) asata_titlebar();
?>
