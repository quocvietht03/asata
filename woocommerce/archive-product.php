...
$fullwidth = isset($asata_options['shop_fullwidth'])&&$asata_options['shop_fullwidth'] ? 'container-fluid': 'bt-container';
$sidebar_width = (int) isset($asata_options['shop_sidebar_width']) ? $asata_options['shop_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;

$shop_top_bar = isset($asata_options['shop_top_bar']) ? $asata_options['shop_top_bar']: false;
$shop_product_per_row = (int) isset($asata_options['shop_product_per_row']) ? $asata_options['shop_product_per_row']: 3;
					...
					<?php if ( have_posts() ) : ?>
						...
						<div class="row products">
							<?php
								...
								if($layout == 'grid3col'){
									$item_wrap_class[] = 'col-md-6 col-lg-'.(12/$shop_product_per_row);
								}elseif($layout == 'grid2col'){
									$item_wrap_class[] = 'col-md-6 col-lg-6';
								}else{
