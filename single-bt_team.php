...
$fullwidth = isset($asata_options['single_team_fullwidth'])&&$asata_options['single_team_fullwidth'] ? 'container-fluid': 'bt-container';
$sidebar_width = (int) isset($asata_options['single_team_sidebar_width']) ?  $asata_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($asata_options['single_team_titlebar']) ? $asata_options['single_team_titlebar']: true;
if($single_team_titlebar) asata_titlebar();
?>
