...
2. Type in asata in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to http://docs.bearsthemes.com/Asata/ for a guide on how to customize this theme.
...
= 1.1 =
* Released: November 15, 2019
 - Add option title bar layout 3 in page options
 - Update mini logo
