...
$page_comment = (int) isset($asata_options['page_comment']) ?  $asata_options['page_comment']: 1;
$sidebar_width = (int) isset($asata_options['sidebar_width']) ?  $asata_options['sidebar_width']: 3;
